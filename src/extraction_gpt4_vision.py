...
def img_to_text(
    images_path: str, output_file_path: str, model="gpt-4-vision-preview", max_retries=1
):
    print("img_to_text")
    ...
    for file in sorted_image_files:
        ...
        extracted_details = extract_tags_function_call(base64_image, model, max_retries)
